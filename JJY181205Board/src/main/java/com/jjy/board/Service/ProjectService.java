...
import com.jjy.board.Vo.Projects.Project;
...
public class ProjectService {
	...
	public String getProject() {
		try {
			...
			HttpGet postRequest = new HttpGet("http://localhost:80/redmine/projects.json?key=604a7786d7a980ab3f223165ee2bae9a9e53a366"); //POST 메소드 URL 새성 
	...
	public String createProject(String id, String name, String identifier) {
		try {
			HttpClient client = HttpClientBuilder.create().build(); // HttpClient 생성
			HttpPost postRequest = new HttpPost("http://localhost:80/redmine/projects.json?key=604a7786d7a980ab3f223165ee2bae9a9e53a366"); //POST 메소드 URL 새성 
			postRequest.setHeader("Accept", "application/json");
			postRequest.setHeader("Connection", "keep-alive");
			postRequest.setHeader("Content-Type", "application/json;charset=UTF-8");
			// postRequest.addHeader("x-api-key","604a7786d7a980ab3f223165ee2bae9a9e53a366"); //KEY 입력 
			...
			//postRequest.setEntity(new StringEntity("{\"user\":{\"login\":\"g67\", \"firstname\":\"test\",\"lastname\":\"123\",\"mail\":\"gs9512221@naver.com\",\"password\":\"dnflxhdzl2\"}}")); 
			//put, post
			postRequest.setEntity(new StringEntity("{\"project\":{\"name\":\""+name+"\", \"identifier\":\""+identifier+"\"}}"));
