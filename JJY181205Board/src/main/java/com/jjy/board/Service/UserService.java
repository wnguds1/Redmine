...
public class UserService {
	public String getUsers() {
		try {
			...
			HttpGet postRequest = new HttpGet("http://localhost:80/redmine/users.json?key=604a7786d7a980ab3f223165ee2bae9a9e53a366"); //POST 메소드 URL 새성 
	...
	public String createUsers(String login, String firstname, String lastname, String mail) {
		try {
