...
$(function(){
	var us = new Array();
	us = ${user}
	console.log(us.users[0].id)
	console.log(us.users.length)             
	
	$.each(us.users, function(idx, users){
		var $tu = $("<tr></tr>").appendTo($("#UserTable"))
		$("<td></td>").text(users.id).appendTo($tu)
		$("<td></td>").text(users.login).appendTo($tu)
		$("<td></td>").text(users.admin).appendTo($tu)
		$("<td></td>").text(users.firstname).appendTo($tu)
		$("<td></td>").text(users.creatlastnameded_on).appendTo($tu)
		$("<td></td>").text(users.mail).appendTo($tu)
		$("<td></td>").text(users.created_on).appendTo($tu)
		$("<td></td>").text(users.last_login_on).appendTo($tu)
