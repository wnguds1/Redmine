...
$(function(){
	...
	$.each(ist.issue_statuses, function(idx, issue_statuses){
		var $tr = $("<tr></tr>").appendTo($("#statusesTable"))
		$("<td></td>").text(issue_statuses.id).appendTo($tr)
		$("<td></td>").text(issue_statuses.name).appendTo($tr)
		$("<td></td>").text(issue_statuses.is_closed).appendTo($tr)
