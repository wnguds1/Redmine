...
$(function(){
	...
	$.each(at.issue.attachments, function(idx, attachments){
		var $tu = $("<tr></tr>").appendTo($("#attachmentsTable"))
		console.log(at.issue.attachments[idx].filename)
		$("<td></td>").text(attachments.id).appendTo($tu)
		$("<td></td>").text(attachments.filename).appendTo($tu)
		$("<td></td>").text(attachments.content_type).appendTo($tu)
		$("<td></td>").text(attachments.filesize).appendTo($tu)
		$("<td></td>").text(attachments.content_url).appendTo($tu)
		$("<td></td>").text(attachments.author.name).appendTo($tu)
		$("<td></td>").text(attachments.created_on).appendTo($tu)
