...
$(function(){
	var mbs = new Array();
	mbs = ${projectMemberships}
	
	console.log(mbs.memberships.length)
              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="createMemberships">
                  <div class="form-group ">
                    <label for="cname" class="control-label col-lg-2" >프로젝트 식별자 (required)</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" name="identiy" minlength="1" type="text" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2">유저 아이디 (required)</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="cemail" type="text" name="user_id" required />
                    </div>
                  </div>
                  <div class="form-group ">
