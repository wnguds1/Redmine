...
$(function(){
	...
	$.each(tk.trackers, function(idx, trackers){
		var $tr = $("<tr></tr>").appendTo($("#trackersTable"))
		$("<td></td>").text(trackers.id).appendTo($tr)
		$("<td></td>").text(trackers.name).appendTo($tr)	
