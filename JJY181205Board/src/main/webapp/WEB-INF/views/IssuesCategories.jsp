...
$(function(){
	...
	$.each(ic.issue_categories, function(idx, issue_categories){
		var $tr = $("<tr></tr>").appendTo($("#issuecategoriesTable"))
		$("<td></td>").text(issue_categories.id).appendTo($tr)
		$("<td></td>").text(issue_categories.name).appendTo($tr)
		$("<td></td>").text(issue_categories.project.id).appendTo($tr)
		$("<td></td>").text(issue_categories.project.name).appendTo($tr)
        ...
        <h3> Issue categories </h3>
          ...
          <div class="col-md-12">
            <div class="form-panel">
             <h3>Lisiting Issue categories</h3>  
            
          
              <form action ="IssuesCategories" method="get">
              <input type="text" name="project_id">
              <button type="submit">프로젝트조회</button>
              </form>
              <hr>
