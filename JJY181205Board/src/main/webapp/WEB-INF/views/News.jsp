...
$(function(){
	var ns = new Array();
	ns = ${news}
	console.log(ns.news[0].id)
	console.log(ns.news.length)             
	
	$.each(ns.news, function(idx, news){
		var $tu = $("<tr></tr>").appendTo($("#NewsTable"))
		$("<td></td>").text(news.id).appendTo($tu)
		$("<td></td>").text(news.project.id).appendTo($tu)
		$("<td></td>").text(news.project.name).appendTo($tu)
		$("<td></td>").text(news.author.id).appendTo($tu)
		$("<td></td>").text(news.author.name).appendTo($tu)
		$("<td></td>").text(news.title).appendTo($tu)
		$("<td></td>").text(news.summary).appendTo($tu)
		$("<td></td>").text(news.created_on).appendTo($tu)
              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="createUsers">
                  <div class="form-group ">
                    <label for="cname" class="control-label col-lg-2" >로그인 아이디 (required)</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" name="login" minlength="2" type="text" required />
                    </div>
                  </div>
                  <div class="form-group ">
                   ...
                   <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2">성 (required)</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="cemail" type="text" name="firstname" required />
                    </div>
                  </div>
                   <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2">이름 (required)</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="cemail" type="text" name="lastname" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="curl" class="control-label col-lg-2 " >메일 (required)</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="curl" type="text" name="mail" />
                    </div>
                  </div>
